...
- [ ] [1.1-02] Add a parity-risk report that identifies current behavior-loss and hidden-config failure modes.
...
- [ ] [6.2-02] Add complete advanced node attributes editor for all spec node attrs.
...
- [ ] [6.5-02] Add parse/lint diagnostics for stylesheet grammar and selectors.
...
- [ ] [6.7-02] Add manager fields (`manager.poll_interval`, `manager.max_cycles`, `manager.stop_condition`, `manager.actions`).
- [ ] [6.7-03] Link manager node config to `stack.child_*` graph attributes in UI workflow.
...
- [ ] [7.3-02] Add fallback UX for diagnostics without direct element mapping.
