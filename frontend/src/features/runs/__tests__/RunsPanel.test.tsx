            ...
            entries: runId === selectedRun.run_id
              ? [
                ...selectedRunJournalEntries.map((entry) => ({
                  ...
                  updated_at: (entry.raw_type === 'StageCompleted' ? entry.emitted_at : null) ?? (entry.emitted_at) ?? '',
                  ...
                  boundary: {
                    ...
                    source_parent_node_id: entry.source_parent_node_id,
                    source_flow_name: entry.source_flow_name,
                    model: null,
                    started_at: entry.emitted_at,
                    ended_at: entry.raw_type === 'StageCompleted' ? entry.emitted_at : null,
                ...
                })),
                {
                  ...
                  updated_at: ('2026-03-22T00:05:00Z') ?? ('2026-03-22T00:05:00Z') ?? '',
                  content: 'Stage done completed',
                  boundary: {
                    node_id: 'done',
                    stage_index: 3,
                    attempt: null,
                    ...
                    model: null,
                    started_at: '2026-03-22T00:05:00Z',
                    ended_at: '2026-03-22T00:05:00Z',
        ...
        if (resource === 'transcript') {
          return jsonResponse({
            ...
            entries: latestEntries.map((entry) => ({
              ...
              timestamp: (entry.emitted_at) ?? '',
              updated_at: (entry.raw_type === 'StageStarted' ? null : entry.emitted_at) ?? (entry.emitted_at) ?? '',
              content: entry.summary,
              boundary: {
                node_id: entry.node_id,
                stage_index: entry.stage_index,
                ...
                model: null,
                started_at: entry.emitted_at,
                ended_at: entry.raw_type === 'StageStarted' ? null : entry.emitted_at,
                summary: entry.summary,
              },
            })),
          })
            ...
            entries: [
              {
                ...
                updated_at: ('2026-03-22T00:02:00Z') ?? ('2026-03-22T00:02:00Z') ?? '',
                content: 'Stage prepare completed',
                boundary: {
                  node_id: 'prepare',
                  stage_index: 1,
                  attempt: null,
                  ...
                  source_flow_name: null,
                  model: null,
                  started_at: '2026-03-22T00:02:00Z',
                  ended_at: '2026-03-22T00:02:00Z',
                  summary: 'Stage prepare completed',
                },
              },
              {
                ...
                updated_at: ('2026-03-22T00:04:00Z') ?? ('2026-03-22T00:03:00Z') ?? '',
                content: 'Stage plan_current completed',
                boundary: {
                  node_id: 'plan_current',
                  stage_index: 2,
                  attempt: null,
                  ...
                  source_flow_name: null,
                  model: null,
                  started_at: '2026-03-22T00:03:00Z',
                  ended_at: '2026-03-22T00:04:00Z',
                  summary: 'Stage plan_current completed',
                },
              },
            ],
