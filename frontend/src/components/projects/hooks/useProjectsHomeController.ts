...
export function useProjectsHomeController() {
    ...
    const setConversationSummaryList = (
        ...
        setConversationCache((current) => setProjectConversationSummaryList(current, projectPath, summaries))
    }
    ...
    const onDeleteConversationThread = async (conversationId: string, title: string) => {
        ...
        try {
            ...
            setConversationCache((current) => removeConversationFromCache(current, conversationId))
    ...
    const onDeleteProject = async (projectPath: string) => {
        ...
        try {
            ...
            setConversationCache((current) => removeProjectFromCache(current, projectPath))
