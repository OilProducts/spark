...
use spark_common::segments::{
    event_text, find_segment, next_turn_segment_order, non_empty_string, normalize_assistant_text,
    remove_key, request_user_input_answer_summary, set_string_value, set_value,
