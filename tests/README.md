...
- `tests/repo_hygiene` contains repository consistency checks such as formatting guards and fixture hygiene. These are useful, but they are not product-behavior evidence.
...
- `tests/compat/fixtures` contains committed compatibility golden manifests. Generated compatibility captures, logs, caches, and temporary homes belong in pytest temporary directories or ignored `tests/compat/.tmp` paths.
