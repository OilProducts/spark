...
const content = '[Desktop HTTPS smoke](https://example.com/?spark-markdown-https=CR-2026-0116-review)\n\n[Desktop HTTP smoke](http://example.com/?spark-markdown-http=CR-2026-0116-review)\n\n[Local file](/tmp/example.ts:12)\n\n[Unsafe](javascript:alert%281%29)';
