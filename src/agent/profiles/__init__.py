...
def __getattr__(name: str) -> Any:
    ...
    exported = {
        ...
        "OpenAICompatibleProviderProfile": OpenAICompatibleProviderProfile,
        "create_anthropic_profile": create_anthropic_profile,
        "create_gemini_profile": create_gemini_profile,
        "create_litellm_profile": create_litellm_profile,
        "create_openai_profile": create_openai_profile,
        "create_openrouter_profile": create_openrouter_profile,
